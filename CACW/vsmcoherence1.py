...
def entity_to_context_scores_ma(candslist, direction, method):
...
def coherence_scores_driver(C, ws=20, method='rvspagerank', direction=DIR_BOTH, 
        op_method="keydisamb", overlap_method=None, stride=19):
